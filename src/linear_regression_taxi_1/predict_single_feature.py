# -*- coding: utf-8 -*-
"""Script to make predictions using the single-feature model."""
...
def predict_fare(trip_miles: float) -> float:
    """Predicts taxi fare based on trip miles."""
    input_data = {"TRIP_MILES": np.array([trip_miles])}
...
if __name__ == "__main__":
    ...
    predicted_fare = predict_fare(trip_miles=example_trip_miles)
